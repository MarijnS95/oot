...
#BOARD_KERNEL_CMDLINE="lpm_levels.sleep_disabled=1 service_locator.enable=1 androidboot.memcg=1 msm_rtb.filter=0x3F ehci-hcd.park=3 coherent_pool=8M sched_enable_power_aware=1 user_debug=31 printk.devkmsg=on kpti=0 androidboot.hardware=$_device
# buildvariant=userdebug veritykeyid=id:$_verity_key_id"
...
BOARD_KERNEL_CMDLINE="$BOARD_KERNEL_CMDLINE buildvariant=userdebug veritykeyid=id:$_verity_key_id"
